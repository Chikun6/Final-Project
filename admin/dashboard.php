...
$quizCount = $conn->query("SELECT COUNT(*) FROM tbl_quiz")->fetch_row()[0];
$enrollCount = $conn->query("SELECT COUNT(*) FROM enrollments")->fetch_row()[0];

$tables = ['users', 'courses', 'chapters', 'lectures', 'enrollments', 'progress', 'tbl-quiz', 'contact'];
?>
...
<div class="container mt-5">
  ...
  <div class="d-flex justify-content-center gap-4">
    ...
    <a href="quize.php" class="btn btn-danger btn-lg d-flex align-items-center px-4 py-2 shadow-sm rounded">
